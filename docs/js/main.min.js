...
***************************************************************************** */
var O=function(){return O=Object.assign||function(t){for(var e,s=1,i=arguments.length;s<i;s++)for(var n in e=arguments[s])Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t},O.apply(this,arguments)},B=function(){return B=Object.assign||function(t){for(var e,s=1,i=arguments.length;s<i;s++)for(var n in e=arguments[s])Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t},B.apply(this,arguments)},U=function(t){return void 0===t&&(t={}),{arrayFormat:t.arrayFormat||"none",booleanFormat:t.booleanFormat||"none",nullFormat:t.nullFormat||"default"}},D=function(t){return encodeURIComponent(t)},z=function(t){return decodeURIComponent(t)},V=function(t,e,s){return null===e?function(t,e){return"hidden"===e.nullFormat?"":"string"===e.nullFormat?t+"=null":t}(t,s):"boolean"==typeof e?function(t,e,s){return"empty-true"===s.booleanFormat&&e?t:t+"="+("unicode"===s.booleanFormat?e?"✓":"✗":e.toString())}(t,e,s):Array.isArray(e)?function(t,e,s){var i=function(t){return"index"===t.arrayFormat?function(t,e){return t+"["+e+"]"}:"brackets"===t.arrayFormat?function(t){return t+"[]"}:function(t){return t}}(s);return e.map((function(e,s){return i(t,s)+"="+D(e)})).join("&")}(t,e,s):t+"="+D(e)},j=function(t){var e=t.indexOf("?");return-1===e?t:t.slice(e+1)},N=function(t){var e=t.indexOf("["),s=-1!==e;return{hasBrackets:s,name:s?t.slice(0,e):t}},F=function(t,e){var s=U(e);return j(t).split("&").reduce((function(t,e){var i=e.split("="),n=i[0],o=i[1],a=N(n),r=a.hasBrackets,l=a.name,c=t[l],d=function(t,e){if(void 0===t)return"empty-true"===e.booleanFormat||null;if("string"===e.booleanFormat){if("true"===t)return!0;if("false"===t)return!1}if("unicode"===e.booleanFormat){if("✓"===z(t))return!0;if("✗"===z(t))return!1}return"string"===e.nullFormat&&"null"===t?null:z(t)}(o,s);return t[l]=void 0===c?r?[d]:d:(Array.isArray(c)?c:[c]).concat(d),t}),{})},G=function(t,e){var s=U(e);return Object.keys(t).filter((function(e){return void 0!==t[e]})).map((function(e){return V(e,t[e],s)})).filter(Boolean).join("&")},q=/[^!$'()*+,;|:]/g,Z=function(t){return t.replace(q,(function(t){return encodeURIComponent(t)}))},W={default:Z,uri:encodeURI,uriComponent:encodeURIComponent,none:function(t){return t},legacy:encodeURI},K={default:decodeURIComponent,uri:decodeURI,uriComponent:decodeURIComponent,none:function(t){return t},legacy:decodeURIComponent},X=function(t,e,s){var i=W[e]||Z;return s?String(t).split("/").map(i).join("/"):i(String(t))},Y=function(t){return"("+(t?t.replace(/(^<|>$)/g,""):"[a-zA-Z0-9-_.~%':|=+\\*@$]+")+")"},J=[{name:"url-parameter",pattern:/^:([a-zA-Z0-9-_]*[a-zA-Z0-9]{1})(<(.+?)>)?/,regex:function(t){return new RegExp(Y(t[2]))}},{name:"url-parameter-splat",pattern:/^\*([a-zA-Z0-9-_]*[a-zA-Z0-9]{1})/,regex:/([^?]*)/},{name:"url-parameter-matrix",pattern:/^;([a-zA-Z0-9-_]*[a-zA-Z0-9]{1})(<(.+?)>)?/,regex:function(t){return new RegExp(";"+t[1]+"="+Y(t[2]))}},{name:"query-parameter",pattern:/^(?:\?|&)(?::)?([a-zA-Z0-9-_]*[a-zA-Z0-9]{1})/},{name:"delimiter",pattern:/^(\/|\?)/,regex:function(t){return new RegExp("\\"+t[0])}},{name:"sub-delimiter",pattern:/^(!|&|-|_|\.|;)/,regex:function(t){return new RegExp(t[0])}},{name:"fragment",pattern:/^([0-9a-zA-Z]+)/,regex:function(t){return new RegExp(t[0])}}],Q=function t(e,s){if(void 0===s&&(s=[]),!J.some((function(i){var n=e.match(i.pattern);return!!n&&(s.push({type:i.name,match:n[0],val:n.slice(1,2),otherVal:n.slice(2),regex:i.regex instanceof Function?i.regex(n):i.regex}),n[0].length<e.length&&(s=t(e.substr(n[0].length),s)),!0)})))throw new Error("Could not parse path '"+e+"'");return s},tt=function(t){return null!=t},et={urlParamsEncoding:"default"},st=function(){function t(t,e){if(!t)throw new Error("Missing path in Path constructor");this.path=t,this.options=B(B({},et),e),this.tokens=Q(t),this.hasUrlParams=this.tokens.filter((function(t){return/^url-parameter/.test(t.type)})).length>0,this.hasSpatParam=this.tokens.filter((function(t){return/splat$/.test(t.type)})).length>0,this.hasMatrixParams=this.tokens.filter((function(t){return/matrix$/.test(t.type)})).length>0,this.hasQueryParams=this.tokens.filter((function(t){return/^query-parameter/.test(t.type)})).length>0,this.spatParams=this.getParams("url-parameter-splat"),this.urlParams=this.getParams(/^url-parameter/),this.queryParams=this.getParams("query-parameter"),this.params=this.urlParams.concat(this.queryParams),this.source=this.tokens.filter((function(t){return void 0!==t.regex})).map((function(t){return t.regex.source})).join("")}return t.createPath=function(e,s){return new t(e,s)},t.prototype.isQueryParam=function(t){return-1!==this.queryParams.indexOf(t)},t.prototype.isSpatParam=function(t){return-1!==this.spatParams.indexOf(t)},t.prototype.test=function(t,e){var s=this,i=B(B({caseSensitive:!1,strictTrailingSlash:!1},this.options),e),n=function(t,e){return e||"\\/"===t?t:t.replace(/\\\/$/,"")+"(?:\\/)?"}(this.source,i.strictTrailingSlash),o=this.urlTest(t,n+(this.hasQueryParams?"(\\?.*$|$)":"$"),i.caseSensitive,i.urlParamsEncoding);if(!o||!this.hasQueryParams)return o;var a=F(t,i.queryParams);return 0===Object.keys(a).filter((function(t){return!s.isQueryParam(t)})).length?(Object.keys(a).forEach((function(t){return o[t]=a[t]})),o):null},t.prototype.partialTest=function(t,e){var s=this,i=B(B({caseSensitive:!1,delimited:!0},this.options),e),n=function(t,e){return e?/(\/)$/.test(t)?t:t+"(\\/|\\?|\\.|;|$)":t}(this.source,i.delimited),o=this.urlTest(t,n,i.caseSensitive,i.urlParamsEncoding);if(!o)return o;if(!this.hasQueryParams)return o;var a=F(t,i.queryParams);return Object.keys(a).filter((function(t){return s.isQueryParam(t)})).forEach((function(t){return function(t,e,s){void 0===s&&(s="");var i=t[e];return t[e]=void 0===i?s:Array.isArray(i)?i.concat(s):[i,s],t}(o,t,a[t])})),o},t.prototype.build=function(t,e){var s=this;void 0===t&&(t={});var i=B(B({ignoreConstraints:!1,ignoreSearch:!1,queryParams:{}},this.options),e),n=Object.keys(t).filter((function(t){return!s.isQueryParam(t)})).reduce((function(e,n){if(!tt(t[n]))return e;var o=t[n],a=s.isSpatParam(n);return"boolean"==typeof o?e[n]=o:Array.isArray(o)?e[n]=o.map((function(t){return X(t,i.urlParamsEncoding,a)})):e[n]=X(o,i.urlParamsEncoding,a),e}),{});if(this.urlParams.some((function(e){return!tt(t[e])}))){var o=this.urlParams.filter((function(e){return!tt(t[e])}));throw new Error("Cannot build path: '"+this.path+"' requires missing parameters { "+o.join(", ")+" }")}if(!i.ignoreConstraints&&!this.tokens.filter((function(t){return/^url-parameter/.test(t.type)&&!/-splat$/.test(t.type)})).every((function(t){return new RegExp("^"+Y(t.otherVal[0])+"$").test(n[t.val])})))throw new Error("Some parameters of '"+this.path+"' are of invalid format");var a=this.tokens.filter((function(t){return!1===/^query-parameter/.test(t.type)})).map((function(t){return"url-parameter-matrix"===t.type?";"+t.val+"="+n[t.val[0]]:/^url-parameter/.test(t.type)?n[t.val[0]]:t.match})).join("");if(i.ignoreSearch)return a;var r=this.queryParams.filter((function(e){return-1!==Object.keys(t).indexOf(e)})).reduce((function(e,s){return e[s]=t[s],e}),{}),l=G(r,i.queryParams);return l?a+"?"+l:a},t.prototype.getParams=function(t){var e=t instanceof RegExp?function(e){return t.test(e.type)}:function(e){return e.type===t};return this.tokens.filter(e).map((function(t){return t.val[0]}))},t.prototype.urlTest=function(t,e,s,i){var n=this,o=new RegExp("^"+e,s?"":"i"),a=t.match(o);return a?this.urlParams.length?a.slice(1,this.urlParams.length+1).reduce((function(t,e,s){return t[n.urlParams[s]]=(K[i]||decodeURIComponent)(e),t}),{}):{}:null},t}(),it=function(t){var e="";return t.reduce((function(t,s){var i,n,o,a,r=null!=(n=null===(i=s.parser)||void 0===i?void 0:i.urlParams.reduce((function(t,e){return t[e]="url",t}),{}))?n:{},l=null!=(a=null===(o=s.parser)||void 0===o?void 0:o.queryParams.reduce((function(t,e){return t[e]="query",t}),r))?a:{};return void 0!==s.name&&(t[e=e?e+"."+s.name:s.name]=l),t}),{})},nt=function t(e,s,i,n,o){void 0===n&&(n={});for(var a=n.queryParamsMode,r=void 0===a?"default":a,l=n.strictTrailingSlash,c=void 0!==l&&l,d=n.strongMatching,h=void 0===d||d,u=n.caseSensitive,p=void 0!==u&&u,m=1===e.length&&""===e[0].name,v=function(e){var a,l=null,d=void 0,u=s;if("/"===o&&"/"===e.path&&(u="/"+s),e.children.length||(l=e.parser.test(u,{caseSensitive:p,strictTrailingSlash:c,queryParams:n.queryParams,urlParamsEncoding:n.urlParamsEncoding})),l||(l=e.parser.partialTest(u,{delimited:h,caseSensitive:p,queryParams:n.queryParams,urlParamsEncoding:n.urlParamsEncoding})),l){var v=e.parser.build(l,{ignoreSearch:!0,urlParamsEncoding:n.urlParamsEncoding});c||e.children.length||(v=v.replace(/\/$/,"")),d=0===u.toLowerCase().indexOf(v.toLowerCase())?u.slice(v.length):u,c||e.children.length||(d=d.replace(/^\/\?/,"?"));var g=function(t,e,s){var i=U(s);if(""===j(t))return{querystring:"",removedParams:{}};var n=t.split("&").reduce((function(t,s){var i=t[0],n=t[1],o=s.split("=")[0],a=N(o).name;return-1===e.indexOf(a)?[i.concat(s),n]:[i,n.concat(s)]}),[[],[]]),o=n[0],a=n[1];return{querystring:o.join("&"),removedParams:F(a.join("&"),i)}}((a=u.replace(v,""),a.split("?")[1]||""),e.parser.queryParams,n.queryParams).querystring;if(d=function(t){return t.split("?")[0]}(d)+(g?"?"+g:""),c||m||"/"!==d||/\/$/.test(v)||(d=""),i.segments.push(e),Object.keys(l).forEach((function(t){return i.params[t]=l[t]})),!m&&!d.length)return{value:i};if(!m&&"strict"!==r&&0===d.indexOf("?")){var f=F(d.slice(1),n.queryParams);return Object.keys(f).forEach((function(t){return i.params[t]=f[t]})),{value:i}}var b=e.getNonAbsoluteChildren();return b.length?{value:t(b,d,i,n,v)}:{value:null}}},g=0,f=e;g<f.length;g++){var b=v(f[g]);if("object"==typeof b)return b.value}return null};
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
